...
exports.UpdateUserBodyDTO = void 0;
...
], UpdateUserBodyDTO.prototype, "firstName", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Smith', description: 'user last name' }),
    (0, class_validator_1.IsString)({ message: 'name mast be string' }),
    (0, class_validator_1.Length)(2, 16, { message: 'name mast be 2 to 16 characters' }),
    __metadata("design:type", String)
], UpdateUserBodyDTO.prototype, "lastName", void 0);
__decorate([
    ...
    __metadata("design:type", String)
], UpdateUserBodyDTO.prototype, "email", void 0);
__decorate([
...
], UpdateUserBodyDTO.prototype, "img", void 0);
