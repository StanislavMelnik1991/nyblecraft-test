...
__decorate([
    (0, swagger_1.ApiProperty)({ example: '1', description: 'user id', type: 'number' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'path.jpeg', description: 'image url' }),
    (0, typeorm_1.Column)({ nullable: false }),
    __metadata("design:type", String)
], User.prototype, "img", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'path.pdf', description: 'pdf url' }),
    (0, typeorm_1.Column)({ nullable: true }),
    __metadata("design:type", String)
], User.prototype, "pdf", void 0);
__decorate([
